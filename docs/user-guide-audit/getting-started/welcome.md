...
- "AIPurview is an AI governance platform that helps organizations keep track of their AI systems, stay compliant with regulations and manage the risks that come with deploying AI." (block 1) — reason: motivational/value-prop framing, not a verifiable claim about functionality or UI.
...
- "AIPurview is source-available." (block 3, callout) — reason: licensing claim; policy/external fact, not product functionality.
