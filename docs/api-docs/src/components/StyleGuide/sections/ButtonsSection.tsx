...
import { Box, Stack, Typography, useTheme, Divider, Snackbar, CircularProgress } from "@mui/material";
import { Copy, Plus, Trash2 } from "lucide-react";
import CodeBlock from "../CodeBlock";

// Mock CustomizableButton component for documentation display
const MockButton: React.FC<{
  ...
  // Color mapping
  const colorMap = {
    primary: { main: "#13715B", hover: "#0f604d", light: "#E6F2EF" },
    secondary: { main: "#6B7280", hover: "#4B5563", light: "#F3F4F6" },
    error: { main: "#DB504A", hover: "#B91C1C", light: "#FEE2E2" },
    success: { main: "#059669", hover: "#047857", light: "#D1FAE5" },
    warning: { main: "#D97706", hover: "#B45309", light: "#FEF3C7" },
    info: { main: "#3B82F6", hover: "#2563EB", light: "#DBEAFE" },
  };
...
// Mock ButtonToggle component for documentation display
const MockButtonToggle: React.FC<{
  options: { label: string; value: string }[];
  value: string;
  onChange: (value: string) => void;
  height?: number;
}> = ({ options, value, onChange, height = 34 }) => {
    ...
    <Box sx={{ p: "32px 40px" }}>
      ...
      <SpecSection title="Button color palette">
        ...
        <Box sx={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
          <MockButton variant="contained" color="primary" text="Primary" />
          <MockButton variant="contained" color="secondary" text="Secondary" />
          <MockButton variant="contained" color="success" text="Success" />
          <MockButton variant="contained" color="warning" text="Warning" />
          <MockButton variant="contained" color="error" text="Error" />
          <MockButton variant="contained" color="info" text="Info" />
        </Box>
      </SpecSection>
