...
import { Box, Stack, Typography, useTheme, Divider, Snackbar, Dialog, DialogTitle, DialogContent, DialogActions, Drawer, Button as MuiButton } from "@mui/material";
import { Copy, X } from "lucide-react";
import CodeBlock from "../CodeBlock";

// Mock Button Component - mimics CustomizableButton behavior
  ...
  return (
    <Box sx={{ p: "32px 40px" }}>
      ...
      <SpecSection title="StandardModal pattern">
        <Typography sx={{ fontSize: 13, color: theme.palette.text.tertiary, mb: "24px" }}>
          AIPurview uses a StandardModal component with useStandardModal hook for consistent modal behavior.
        </Typography>
