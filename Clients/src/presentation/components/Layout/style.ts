...
export const actionButtonsStyles = {
  ...
  approval_workflows: {
    ...
    "border": `1px solid ${palette.border.light}`,
    "&:hover": {
      backgroundColor: palette.accent.primary.bg,
      borderColor: palette.accent.primary.border,
    },
  },
  integrations: {
    "backgroundColor": "transparent",
    ...
    "&:hover": {
      ...
      borderColor: palette.accent.purple.border,
    },
    "&.Mui-disabled": {
      backgroundColor: "transparent",
      color: palette.accent.purple.text,
  ...
  automations: {
    ...
    "&:hover": {
      ...
      borderColor: palette.accent.orange.border,
    },
  },
};
