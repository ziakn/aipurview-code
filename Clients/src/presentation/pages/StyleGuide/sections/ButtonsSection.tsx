    ...
    <Box sx={{ p: "32px 40px" }}>
      ...
      <SpecSection title="Button color palette">
        ...
        <Box sx={{ display: "flex", gap: "16px", flexWrap: "wrap", mb: "24px" }}>
          ...
          <ColorSwatch label="Warning" color=status.warning.text hoverColor="#5D4037" onCopy={handleCopy} />
          <ColorSwatch label="Error" color=status.error.text hoverColor="#B71C1C" onCopy={handleCopy} />
          <ColorSwatch label="Info" color=status.info.text hoverColor="#0D47A1" onCopy={handleCopy} />
        </Box>
