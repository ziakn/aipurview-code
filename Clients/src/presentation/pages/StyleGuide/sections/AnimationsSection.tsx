  ...
  return (
    <Box sx={{ p: "32px 40px" }}>
      ...
      <Box sx={{ mb: "32px" }}>
        ...
        >
          AIPurview uses subtle, fast transitions. Most button interactions have no transition for
      ...
      <SpecSection title="Disabled transitions">
        <Typography sx={{ fontSize: 13, color: theme.palette.text.tertiary, mb: "24px" }}>
          AIPurview intentionally disables transitions on buttons and interactive elements for
