jest.mock("sequelize-typescript", () => ({
  Column: jest.fn(), DataType: {
    ...
    DATE: "DATE", BOOLEAN: "BOOLEAN", JSONB: "JSONB", NOW: "NOW", ARRAY: jest.fn(),
  },
...
class TestAiTrustCenterInfoModel {
  id?: number; organization_id!: number; company_name!: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreCompanyDescriptionModel {
  id?: number; organization_id!: number; description!: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreComplianceBadgesModel {
  id?: number; organization_id!: number; badge_name!: string; badge_url?: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreIntroModel {
  id?: number; organization_id!: number; intro_text!: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreResourcesModel {
  id?: number; organization_id!: number; resource_name!: string; resource_url!: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreSubprocessorsModel {
  id?: number; organization_id!: number; name!: string; purpose?: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}

class TestAiTrustCentreTermsAndContractModel {
  id?: number; organization_id!: number; title!: string; content?: string;
  constructor(data?: any) { if (data) Object.assign(this, data); }
}
...
describe("AI Trust Centre Models", () => {
  describe("AiTrustCenterInfoModel", () => {
    it("should instantiate with required fields", () => {
      const m = new TestAiTrustCenterInfoModel({ id: 1, organization_id: 1, company_name: "Acme Corp" });
  ...
  describe("AiTrustCentreCompanyDescriptionModel", () => {
    it("should instantiate with description", () => {
      const m = new TestAiTrustCentreCompanyDescriptionModel({
        organization_id: 1, description: "We build responsible AI",
      });
  ...
  describe("AiTrustCentreComplianceBadgesModel", () => {
    it("should store badge info", () => {
      const m = new TestAiTrustCentreComplianceBadgesModel({
        organization_id: 1, badge_name: "ISO 27001", badge_url: "https://example.com/badge.png",
      });
  ...
  describe("AiTrustCentreIntroModel", () => {
    it("should store intro text", () => {
      const m = new TestAiTrustCentreIntroModel({ organization_id: 1, intro_text: "Welcome to our trust centre" });
  ...
  describe("AiTrustCentreResourcesModel", () => {
    it("should store resource info", () => {
      const m = new TestAiTrustCentreResourcesModel({
        organization_id: 1, resource_name: "Whitepaper", resource_url: "https://example.com/wp.pdf",
      });
  ...
  describe("AiTrustCentreSubprocessorsModel", () => {
    it("should store subprocessor info", () => {
      const m = new TestAiTrustCentreSubprocessorsModel({
        organization_id: 1, name: "AWS", purpose: "Cloud hosting",
      });
  ...
  describe("AiTrustCentreTermsAndContractModel", () => {
    it("should store terms info", () => {
      const m = new TestAiTrustCentreTermsAndContractModel({
        organization_id: 1, title: "Terms of Service", content: "Lorem ipsum...",
      });
