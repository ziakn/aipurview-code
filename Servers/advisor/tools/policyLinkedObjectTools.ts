export const toolsDefinition: any[] = [
    {
        ...
        function: {
            ...
            description: "Get all objects linked to a specific policy. Returns linked risks, evidence items, and other entities that are associated with the policy for compliance tracking.",
            parameters: {
                type: "object",
                properties: {
                    policy_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Link an object (risk, evidence, etc.) to a policy. This creates an association between the object and the policy for compliance tracking. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    policy_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Remove the link between an object and a policy. This does not delete the object itself, only the association. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    policy_id: {
