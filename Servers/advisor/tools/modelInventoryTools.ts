export const toolsDefinition: any[] = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all AI models linked to a specific use case (project). The product UI labels projects as 'use cases'. Returns models registered against the given use case across any framework context.",
            parameters: {
                type: "object",
                properties: {
                    project_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all use cases (projects) a given model is linked to. Inverse of list_models_for_use_case. Returns the project_id, project name, and goal for each linked use case.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Remove the link between a model and a use case (project). Deletes all rows in the join table matching (model_id, project_id) regardless of framework context. Does not delete the model or the project. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all AI models linked to a specific compliance framework (e.g., ISO 42001, ISO 27001, EU AI Act). Returns models that have been mapped into the framework's compliance scope.",
            parameters: {
                type: "object",
                properties: {
                    framework_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all compliance frameworks a given model is mapped into. Inverse of list_models_for_framework. Returns framework_id and framework name for each link.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Map a model into a compliance framework's scope under a specific use case (project). Inserts (model_id, project_id, framework_id) into the join table. The project context is required because the link table's UNIQUE constraint covers all three. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
                    ...
                    project_id: {
                        type: "number",
                        description: "The use case (project) ID providing the context for this framework mapping."
                    },
                    framework_id: {
                        type: "number",
    ...
    },
    {
        ...
        function: {
            ...
            description: "Remove a model from a compliance framework's scope. Deletes rows from the join table matching (model_id, framework_id). If project_id is provided, deletion is scoped to that single project context; otherwise removes all framework links for the model. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
                    ...
                    project_id: {
                        type: "number",
                        description: "Optional. If provided, scopes the unlink to this single use case (project). If omitted, unlinks the model from this framework across all projects."
                    }
                },
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all evidence files attached to a model. Returns file id, filename, type, size, version, review_status, uploaded_time and uploaded_by for each linked file. Files must already be uploaded via the file controller — this tool does not upload.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Attach an existing uploaded file to a model as evidence. The file must already exist in the files table (uploaded via /api/files). Inserts a row into file_entity_links with entity_type='model_inventory'. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Remove the evidence link between a file and a model. Deletes the file_entity_links row but does NOT delete the underlying file (it may be linked to other entities). Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "List all datasets a model is linked to (e.g., training data, evaluation data). Returns dataset id, name, version, owner, type, source, classification, contains_pii, status, plus the relationship_type from the join table.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Link a model to a dataset (e.g., declare that the model was trained or evaluated on the dataset). Inserts into dataset_model_inventories. If a link already exists, returns success=false. Requires user confirmation before executing. This is the model-side mirror of agent_link_dataset_to_model.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
                    ...
                    relationship_type: {
                        type: "string",
                        description: "Optional relationship label (e.g., 'trained_on', 'evaluated_on', 'fine_tuned_on'). Defaults to 'trained_on' to match agent_link_dataset_to_model."
                    }
                },
    ...
    },
    {
        ...
        function: {
            ...
            description: "Remove the link between a model and a dataset. Deletes the row in dataset_model_inventories. Does not delete the model or the dataset. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    model_id: {
