export const toolsDefinition: any[] = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Create a new evidence item in the evidence hub. Evidence items document compliance artifacts such as audit reports, test results, and certifications. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    name: {
                    ...
                    type: {
                        type: "string",
                        description: "The type of evidence (e.g., 'Audit Report', 'Test Results', 'Certification', 'Policy Document')."
                    },
                    description: {
                        type: "string",
                    ...
                    expiry_date: {
                        type: "string",
                        description: "Optional expiry date in ISO 8601 format (e.g., '2025-12-31'). Leave empty for non-expiring evidence."
                    }
                },
                required: ["name", "type"]
            }
    ...
    },
    {
        ...
        function: {
            ...
            description: "Update an existing evidence item's properties. Only the provided fields will be updated. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    evidence_id: {
                    ...
                    expiry_date: {
                        type: "string",
                        description: "Updated expiry date in ISO 8601 format, or empty string to remove expiry."
                    }
                },
    ...
    },
    {
        ...
        function: {
            ...
            description: "Delete an evidence item from the evidence hub. This permanently removes the evidence and its file associations. Requires user confirmation before executing.",
            parameters: {
                type: "object",
                properties: {
                    evidence_id: {
