...
export const AGENT_TOOL_MAP: AgentToolEntry[] = [
  ...
  },
  {
    ...
    tools: ["analyze_document", "score_evidence_quality", "match_controls", "detect_evidence_gaps"],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      "get_training_changes_history",
      "search_trainings",
      "get_training_completion_rate",
      "agent_create_training",
      "agent_update_training",
      "agent_delete_training",
    ],
  },
];
