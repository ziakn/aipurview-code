...
export function registerModelAgent() {
  return createDomainAgent({
    name: "model-agent",
    description: "AI model governance specialist — model lifecycle, risk assessment, deployment governance",
    ...
    tools: [
      // Read tools
      "fetch_model_inventory", "get_model_inventory_by_id", "get_model_inventory_analytics",
      "get_model_inventory_changes_history", "search_model_inventory",
      "get_model_lifecycle_status", "get_model_deployment_info",
