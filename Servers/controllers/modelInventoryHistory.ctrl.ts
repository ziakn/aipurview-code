...
} from "../utils/history/modelInventoryHistory.utils";
 ...
 * Query params:
 * - parameter: string (required) - The parameter to track (e.g., 'status')
 ...
 * Note: The snapshot counts will be automatically stored in change_description as JSONB
 */
