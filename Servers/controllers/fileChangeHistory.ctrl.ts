 ...
 */
export async function getFileChangeHistoryById(req: Request, res: Response): Promise<any> {
  ...
  try {
    const result = await getEntityChangeHistory("file", fileId, req.organizationId!, limit, offset);
