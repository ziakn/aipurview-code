 ...
 */
export async function getPolicyChangeHistoryById(req: Request, res: Response): Promise<any> {
  ...
  try {
    const result = await getPolicyChangeHistory(policyId, req.organizationId!, limit, offset);
