...
module.exports = {
  ...
  async down(queryInterface) {
    ...
    try {
      // Drop org indexes
      await queryInterface.sequelize.query(`DROP INDEX IF EXISTS verifywise.idx_fria_rights_org;`, {
        transaction,
      });
      await queryInterface.sequelize.query(
        `DROP INDEX IF EXISTS verifywise.idx_fria_risk_items_org;`,
        { transaction },
      );
      await queryInterface.sequelize.query(
        `DROP INDEX IF EXISTS verifywise.idx_fria_model_links_org;`,
        { transaction },
      );
      await queryInterface.sequelize.query(
        `DROP INDEX IF EXISTS verifywise.idx_fria_snapshots_org;`,
        { transaction },
      );
      await queryInterface.sequelize.query(
        `DROP INDEX IF EXISTS verifywise.idx_fria_change_history_org;`,
        { transaction },
      );
