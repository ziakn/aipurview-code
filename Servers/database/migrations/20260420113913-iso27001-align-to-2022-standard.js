...
const ANNEX_RENAMES = [
  // A.5 wording
  { annex: 5, oldTitle: 'Inventory of information and assets', newTitle: 'Inventory of information and other associated assets' },
  { annex: 5, oldTitle: 'Acceptable use of information and assets', newTitle: 'Acceptable use of information and other associated assets' },
  ...
  { annex: 5, oldTitle: 'Access to networks and network services', newTitle: 'Identity management' },
  { annex: 5, oldTitle: 'User registration and de-registration', newTitle: 'Authentication information' },
  { annex: 5, oldTitle: 'Management of privileged access rights', newTitle: 'Access rights' },
  { annex: 5, oldTitle: 'Management of secret authentication information', newTitle: 'Information security in supplier relationships' },
  { annex: 5, oldTitle: 'Review of user access rights', newTitle: 'Addressing information security within supplier agreements' },
  { annex: 5, oldTitle: 'Removal or adjustment of access rights', newTitle: 'Managing information security in the ICT supply chain' },
  { annex: 5, oldTitle: 'Use of secret authentication information', newTitle: 'Monitoring, review and change management of supplier services' },
  { annex: 5, oldTitle: 'Information security in supplier relationships', newTitle: 'Information security for use of cloud services' },
  { annex: 5, oldTitle: 'Addressing information security within supplier agreements', newTitle: 'Information security incident management planning and preparation' },
  { annex: 5, oldTitle: 'Information and communication technology supply chain security', newTitle: 'Assessment and decision on information security events' },
  { annex: 5, oldTitle: 'Monitoring, review, and change management of supplier services', newTitle: 'Response to information security incidents' },
  { annex: 5, oldTitle: 'Incident management responsibilities and procedures', newTitle: 'Learning from information security incidents' },
  { annex: 5, oldTitle: 'Reporting information security events', newTitle: 'Collection of evidence' },
  { annex: 5, oldTitle: 'Reporting information security weaknesses', newTitle: 'Information security during disruption' },
  { annex: 5, oldTitle: 'Assessment and decision on information security events', newTitle: 'ICT readiness for business continuity' },
  { annex: 5, oldTitle: 'Response to information security incidents', newTitle: 'Legal, statutory, regulatory and contractual requirements' },
  { annex: 5, oldTitle: 'Learning from information security incidents', newTitle: 'Intellectual property rights' },
  { annex: 5, oldTitle: 'Collection of evidence', newTitle: 'Protection of records' },
  { annex: 5, oldTitle: 'Business continuity planning for information security', newTitle: 'Privacy and protection of personal information' },
  { annex: 5, oldTitle: 'Redundancy of information processing facilities', newTitle: 'Independent review of information security' },
  { annex: 5, oldTitle: 'Documented operating procedures', newTitle: 'Compliance with policies, rules and standards' },

  // A.6 reorder
  { annex: 6, oldTitle: 'Confidentiality or non-disclosure agreements', newTitle: 'Responsibilities after termination or change of employment' },
  { annex: 6, oldTitle: 'Remote working', newTitle: 'Confidentiality or non-disclosure agreements' },
  { annex: 6, oldTitle: 'Termination or change of employment responsibilities', newTitle: 'Remote working' },
  { annex: 6, oldTitle: 'User responsibilities', newTitle: 'Information security event reporting' },

  // A.7 reorder
  { annex: 7, oldTitle: 'Protecting against physical and environmental threats', newTitle: 'Physical security monitoring' },
  { annex: 7, oldTitle: 'Working in secure areas', newTitle: 'Protecting against physical and environmental threats' },
  ...
  { annex: 7, oldTitle: 'Clear desk and clear screen policy', newTitle: 'Secure disposal or re-use of equipment' },
  ...
  { annex: 8, oldTitle: 'Development, testing and operational environments', newTitle: 'Capacity management' },
  { annex: 8, oldTitle: 'Protection of test data', newTitle: 'Protection against malware' },
  { annex: 8, oldTitle: 'Logging and monitoring', newTitle: 'Management of technical vulnerabilities' },
  ...
  { annex: 8, oldTitle: 'Key management', newTitle: 'Redundancy of information processing facilities' },
  ...
  { annex: 8, oldTitle: 'Web filtering', newTitle: 'Installation of software on operational systems' },
  ...
  { annex: 8, oldTitle: 'Information transfer policies and procedures', newTitle: 'Segregation of networks' },
  { annex: 8, oldTitle: 'Electronic messaging', newTitle: 'Web filtering' },
  { annex: 8, oldTitle: 'Confidentiality of information in networks', newTitle: 'Use of cryptography' },
  ...
  { annex: 8, oldTitle: 'Technical vulnerability management', newTitle: 'Secure system architecture and engineering principles' },
  { annex: 8, oldTitle: 'Configuration management', newTitle: 'Secure coding' },
  { annex: 8, oldTitle: 'Monitoring of system use', newTitle: 'Security testing in development and acceptance' },
  { annex: 8, oldTitle: 'Protection of application services', newTitle: 'Outsourced development' },
  { annex: 8, oldTitle: 'Data masking', newTitle: 'Separation of development, test and production environments' },
];
...
const NEW_ANNEX_CONTROLS = [
  {
    ...
    requirement_summary: 'Document operating procedures for information processing facilities and make them available to personnel who need them.',
  },
  {
    annex: 8,
    control_id: 'A.8.32',
    ...
    requirement_summary: 'Control changes to information processing facilities through formal procedures including submission, assessment, authorization, implementation, and review.',
  },
  {
    annex: 8,
    control_id: 'A.8.33',
    ...
    requirement_summary: 'Select, protect, and manage test information. Avoid production data with personal/sensitive content; apply masking or anonymization when production data must be used.',
  },
  {
    annex: 8,
    control_id: 'A.8.34',
    ...
    requirement_summary: 'Plan and coordinate audit tests to minimize business disruption. Restrict scope and schedule tests outside business hours where possible.',
  },
];
...
const NEW_SUBCLAUSES = [
  {
    ...
    requirement_summary: 'When planning for the ISMS, consider the issues from 4.1 and requirements from 4.2 to determine risks and opportunities that need to be addressed to ensure the ISMS achieves its intended outcomes.',
  },
  {
    clauseNo: 6,
    subclause_id: '6.3',
    ...
    try {
      ...
      if (clause6?.id) {
        ...
        for (const sub of NEW_SUBCLAUSES) {
          const [[existing]] = await queryInterface.sequelize.query(
            ...
            { transaction: t, replacements: { clauseId: clause6.id, subclause_id: sub.subclause_id } }
          );
      ...
      for (const ctrl of NEW_ANNEX_CONTROLS) {
        ...
        const [[existing]] = await queryInterface.sequelize.query(
          ...
          { transaction: t, replacements: { categoryId: category.id, control_id: ctrl.control_id } }
        );
        let structId = existing?.id;
        if (!structId) {
          const [[inserted]] = await queryInterface.sequelize.query(
      ...
      await t.commit();
      console.log('[iso27001-2022] clause 6 split, annex renames, phantom removal, and new controls applied');
    } catch (err) {
      await t.rollback();
      throw err;
    }
