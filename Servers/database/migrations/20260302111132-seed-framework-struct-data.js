...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.sequelize.query(
        `DELETE FROM verifywise.nist_ai_rmf_subcategories_struct;`,
        { transaction },
      );
      await queryInterface.sequelize.query(
        `DELETE FROM verifywise.nist_ai_rmf_categories_struct;`,
        { transaction },
      );
      await queryInterface.sequelize.query(
      ...
      await queryInterface.sequelize.query(
        `DELETE FROM verifywise.annexcategories_struct_iso27001;`,
        { transaction },
      );
      await queryInterface.sequelize.query(`DELETE FROM verifywise.annex_struct_iso27001;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.subclauses_struct_iso27001;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.clauses_struct_iso27001;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.annexcategories_struct_iso;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.annex_struct_iso;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.subclauses_struct_iso;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.clauses_struct_iso;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.subcontrols_struct_eu;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.controls_struct_eu;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.controlcategories_struct_eu;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.questions_struct_eu;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.subtopics_struct_eu;`, {
        transaction,
      });
      await queryInterface.sequelize.query(`DELETE FROM verifywise.topics_struct_eu;`, {
        transaction,
      });
      ...
      if (!euFrameworkId) {
        ...
        const {
          Topics,
        } = require("../../dist/structures/EU-AI-Act/assessment-tracker/topics.struct");
        const {
          ControlCategories,
      ...
      if (!iso27001FrameworkId) {
        ...
        const {
          ISO27001Clause,
        } = require("../../dist/structures/ISO-27001/clauses/iso27001.clause.struct");
        const {
          ISO27001Annex,
      ...
      if (!nistFrameworkId) {
        ...
        const {
          NIST_AI_RMF_Structure,
        } = require("../../dist/structures/NIST-AI-RMF/nist-ai-rmf.structure");
